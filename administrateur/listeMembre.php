...
Veuillez saisir la raison du bannissement de '.Membre::info($_POST['id'], 'login').' :
...
if(!empty($_POST['validBannir'])) {
	Admin::bannir($_POST['id'], $_POST['contenu']);
}
...
if(!empty($_POST['inscription'])) {
	Activation::activationAuto(Membre::info($_POST['id'], 'login'));
}
echo '<tr>
