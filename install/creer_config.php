...
if(!empty($_POST['creer_base'])) {
	...
	if(!empty($Base)) {
		...
		try {
			...
			try {
				Bdd::connectBdd();
				$ok .= 'Connexion mysql : <img src="../../Images/check.png" width="56" height="56" align="absmiddle"><br />';
				...
				$config .= "$";
				$config .= "PARAM_pass_site    = '".$Pass_Site."'; \n";
				$config .= "$";
				$config .= "PARAM_url_site    = '".$Url_Site."'; \n";
				$config .= "?>";
				if(fwrite($fp,$config)) {
					$ok .= 'le fichier de connexion &agrave; la base de donn&eacute;s : <img src="../../Images/check.png" width="56" height="56" align="absmiddle"><br />';
				}
				else {
					$err .= 'le fichier de connexion &agrave; la base de donn&eacute;s : <img src="'.$Url_Site.'/Images/alert.png" width="56" height="56" align="absmiddle"><br />';
				}
			} 
			catch(Exception $e) {
					$err .= 'La Base mysql est : <img src="../../Images/alert.png" width="56" height="56" align="absmiddle"><br />';
					die();
			}
		}
		catch(Exception $e) {
