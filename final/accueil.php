						...
						<div id="mask">
							...
							<ul>
								<li id="first" class="firstanimation">	
									<img src="Images/presentation.png" alt="image1"/>
								</li>
			...
			<section class="prearticle">
				...
				while( ($ligne=$req->fetch(PDO::FETCH_ASSOC)) && $count<2 ) {
					...
					<div class="flexcom" >
						...
						<div class="flexc2">
							<a class="titre" href="articles/articles.php?titre='. $ligne['titre'].'">' . rawurldecode($ligne['titre']) . '</a><br/>'.
							substr($ligne['contenu'], 0, 500).'... <a class="contenu" href="articles/articles.php?titre='. $ligne['titre'].'"> Lire la suite...</a></br>
						</div>
					</div>';
					$count++;
				}
